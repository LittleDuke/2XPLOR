...
<html lang="en">
<head>
    <link href="%(dotdot)s%(STATIC_PATH)sbootstrap.min.css" type="text/css" rel="stylesheet" />
    <link href="%(dotdot)s%(STATIC_PATH)shtdocs/style.css" type="text/css" rel="stylesheet" />
    <link rel="shortcut icon" href="%(dotdot)s%(STATIC_PATH)sfavicon.ico?v=2" />
    <title>2GiveCoin</title>
</head>
<body>
<div class="navbar navbar-default navbar-top" role="navigation">
        <div class="container">
                <div class="navbar-header">
                        <a class="navbar-brand" href="/chain/2GiveCoin">
                        <img class="logo" alt="PMC" src="%(dotdot)s%(STATIC_PATH)slogogive.png" height="40" style="margin-top:-10px;">2GiveCoin
                        </a>
                </div>
                <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                                <li class="active">
                                <a href="/chain/2GiveCoin">Home</a>
                                </li>
                                <li>
                                <a href="/chain/2GiveCoin/q">API</a>
                                </li>
                        </ul>
                </div>
        </div>
...
<div class="container maincontent" role="main">
    <div class="jumbotron jumbo_small welcome"><form action="../search">
<input class="srch" placeholder="Search by address, block number or hash, transaction or public key hash, or chain name" name="q" size="64" value=""><button class="srch_btn btn btn-big" type="submit">Search</button>
<br>Address or hash search requires at least the first 6 characters.</form></div>
    ...
    <p style="font-size: smaller">
        <span style="font-style: italic">
            Powered by <a href="https://doabitofgood.com">Do A Bit Of Good!</a>
        </span>
        %(download)s
        Please consider donating to their <a href="https://doabitofgood.com/bit4bit">#bit4bit</a> funds
    </p>
</body>
</html>
